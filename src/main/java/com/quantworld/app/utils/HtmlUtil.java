...
public class HtmlUtil {
  ...
  public static Map<String, Map<String, String>> parseHtmlTwo(InputStream in) {
    Map<String, Map<String, String>> resultMap = new ConcurrentHashMap<String, Map<String, String>>();
    try {
      Document doc = Jsoup.parse(in, "UTF-8", "");
  ...
  public static void importHtmlMore(File in) {
    try {
      ...
      Map<String, List<Map>> resultMap = new ConcurrentHashMap<String, List<Map>>();
  ...
  public static Map<String, List<Map>> parseElements(Element element, Map<String, List<Map>> resultMap) {
    Map<String, Map> favoritesMap = new ConcurrentHashMap<String, Map>();
    Map<String, String> urlMap = new ConcurrentHashMap<String, String>();
    String favoritesName = "";
